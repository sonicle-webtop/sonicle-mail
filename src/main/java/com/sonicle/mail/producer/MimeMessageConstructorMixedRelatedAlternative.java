 ...
 *     - attachments
 * 
 * https://blogs.technet.microsoft.com/exchange/2011/04/21/mixed-ing-it-up-multipartmixed-messages-and-you/
 * 
 * Heavily inspired by https://github.com/bbottema/simple-java-mail
 * @author malbinola
 */
public class MimeMessageConstructorMixedRelatedAlternative extends MimeMessageConstructor {
	...
	void populateMimeMessageMultipartStructure(MimeMessage message, EmailMessage email) throws MessagingException {
		...
		setEmbeddedImages(email, multipartStructureWrapper.multipartRelated);
