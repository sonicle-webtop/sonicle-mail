 ...
 * @author malbinola
 */
public class MimeMessageConstructorMixed extends MimeMessageConstructor {
	...
	void populateMimeMessageMultipartStructure(MimeMessage message, EmailMessage email) throws MessagingException {
		...
		setTexts(email, multipartRootMixed);
		configureForwarding(email, multipartRootMixed);
		setAttachments(email, multipartRootMixed);
