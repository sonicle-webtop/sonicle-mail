 ...
 * @author malbinola
 */
public class MimeMessageConstructorRelatedAlternative extends MimeMessageConstructor {
	...
	void populateMimeMessageMultipartStructure(MimeMessage message, EmailMessage email) throws MessagingException {
		...
		setEmbeddedImages(email, multipartStructureWrapper.multipartRootRelated);
