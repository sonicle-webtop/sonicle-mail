...
public enum Ricevuta {
	...
	public static Ricevuta fromHeaderValue(String headerValue) {
		return Stream.of(Ricevuta.values()).filter(t -> t.getHeaderValue().equalsIgnoreCase(headerValue)).findAny().orElse(null);
	}
}
